...
function gotResults(error,results)
{
  if(error){
      ...
      img=document.getElementsByClassName('alien1');
      img1=document.getElementsByClassName('alien2');
      img2=document.getElementsByClassName('alien3');
      img3=document.getElementsByClassName('alien4');
